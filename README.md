...
Owns notificationsdb. Consumes shipment.* events and records simulated email notifications.
...
```bash
npm ci
npm run dev        # tsx watch, listens on 3005
...
`ghcr.io/echelon-luxe/logitrack-notification-service:<git-sha>`.
